...
# 1. Tu llave de Gemini
genai.configure(api_key="AQ.Ab8RN6KICT3gakaxUh5BEuotrV3YoTtIbGetfQBN0b0aVPLPGw")

# 2. El Prompt Maestro de Alexia (Basado en el manual oficial de English Ya)
...
- Detecta automáticamente el idioma en que te escriben y responde siempre en ese mismo idioma[cite: 1].
...
# 3. Configuramos el cerebro
modelo = genai.GenerativeModel(
    model_name='gemini-3.6-flash',
    system_instruction=INSTRUCCIONES_ALEXIA
)

print("🤖 Alexia con el manual de English Ya listo... (Escribe 'salir' para terminar)")
